  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-accent-50 via-blue-50 to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-primary-200 rounded-full mix-blend-multiply filter blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-accent-200 rounded-full mix-blend-multiply filter blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-soft border border-primary-200 mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {aiFeatures.map((feature, index) => (
              <div
                key={index}
                className="group p-6 bg-white rounded-2xl shadow-soft border border-secondary-100 hover:shadow-medium hover:border-primary-200 transition-all duration-300"
              >
          ...
          <div className="bg-white rounded-2xl shadow-medium border border-secondary-100 p-8 md:p-12">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <MessageSquare className="w-5 h-5 text-accent-600 mt-1 flex-shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <Brain className="w-5 h-5 text-accent-600 mt-1 flex-shrink-0" />
                    <div>
                      <div className="font-semibold text-secondary-900 mb-1">
                        Adaptive Learning
                      </div>
              ...
              <div className="bg-secondary-50 rounded-2xl p-6 shadow-soft">
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="bg-white rounded-2xl rounded-tl-none px-4 py-3 shadow-soft">
                  ...
                  <div className="flex items-start gap-3 flex-row-reverse">
                    ...
                    <div className="bg-gradient-to-br from-primary-600 to-accent-600 text-white rounded-2xl rounded-tr-none px-4 py-3 shadow-medium">
                      <p className="text-sm">
                  ...
                  <div className="text-center">
                    <span className="text-xs text-secondary-500 bg-white px-3 py-1 rounded-full shadow-soft">
                      AI is typing...
                    </span>
                  </div>
                </div>
